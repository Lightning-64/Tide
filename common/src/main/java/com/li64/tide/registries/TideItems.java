...
public class TideItems {
    ...
    public static final Item ENCHANTED_GOLDEN_APPLE_FISHING_BOBBER = register("enchanted_golden_apple_fishing_bobber", new EnchantedGoldenAppleBobberItem(new Item.Properties().food(Foods.ENCHANTED_GOLDEN_APPLE)));
    ...
    public static final Item TORN_NOTE = register("torn_note", new TornNoteItem(new Item.Properties().stacksTo(1)));
