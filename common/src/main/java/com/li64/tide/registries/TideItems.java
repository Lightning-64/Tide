...
public class TideItems {
    ...
    public static final Item WHITE_FISHING_BOBBER = register("white_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item ORANGE_FISHING_BOBBER = register("orange_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item MAGENTA_FISHING_BOBBER = register("magenta_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item LIGHT_BLUE_FISHING_BOBBER = register("light_blue_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item YELLOW_FISHING_BOBBER = register("yellow_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item LIME_FISHING_BOBBER = register("lime_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item PINK_FISHING_BOBBER = register("pink_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item GRAY_FISHING_BOBBER = register("gray_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item LIGHT_GRAY_FISHING_BOBBER = register("light_gray_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item CYAN_FISHING_BOBBER = register("cyan_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item PURPLE_FISHING_BOBBER = register("purple_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item BLUE_FISHING_BOBBER = register("blue_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item BROWN_FISHING_BOBBER = register("brown_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item GREEN_FISHING_BOBBER = register("green_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item RED_FISHING_BOBBER = register("red_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));
    public static final Item BLACK_FISHING_BOBBER = register("black_fishing_bobber",
            new FishingBobberItem(new Item.Properties()));

    public static final Item FISHING_HOOK = register("fishing_hook",
            new FishingHookItem(new Item.Properties()));
    public static final Item IRON_FISHING_HOOK = register("iron_fishing_hook",
            new FishingHookItem(new Item.Properties(), "item.tide.iron_hook.desc"));
    public static final Item LAVAPROOF_FISHING_HOOK = register("lavaproof_fishing_hook",
            new FishingHookItem(new Item.Properties(), "item.tide.lavaproof_hook.desc"));

    public static final Item FISHING_LINE = register("fishing_line",
            new FishingLineItem(new Item.Properties()));
    public static final Item BRAIDED_LINE = register("braided_line",
            new FishingLineItem(new Item.Properties(), "item.tide.braided_line.desc"));
    public static final Item REINFORCED_LINE = register("reinforced_line",
            new FishingLineItem(new Item.Properties(), "item.tide.reinforced_line.desc"));
    public static final Item FORTUNE_LINE = register("fortune_line",
            new FishingLineItem(new Item.Properties(), "item.tide.fortune_line.desc"));
