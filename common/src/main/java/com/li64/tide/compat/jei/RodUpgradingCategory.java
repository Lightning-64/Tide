...
public class RodUpgradingCategory implements IRecipeCategory<RodUpgradingRecipe> {
    ...
    public static final ResourceLocation GUI_LOCATION = Tide.resource("textures/gui/container/angler_workshop_jei.png");
    ...
    public RodUpgradingCategory(IGuiHelper guiHelper) {
        this.guiBg = guiHelper.createDrawable(GUI_LOCATION, 0, 0, 176, 84);
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                TideBlocks.ANGLER_WORKSHOP.asItem().getDefaultInstance());
    }

    @Override
    public @NotNull RecipeType<RodUpgradingRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RodUpgradingRecipe recipe, @NotNull IFocusGroup focusGroup) {
